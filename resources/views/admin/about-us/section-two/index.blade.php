            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Section Two Content</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div style="margin-bottom: 10px;" class="row">
                        <div class="col-lg-12 text-end">
                            <a class="btn btn-success" href="{{ route('admin.about-us.section-2.create') }}">
                                    ...
                                    <tbody id="filteredData">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.about-us.delete', $content->id) }}" method="GET"
