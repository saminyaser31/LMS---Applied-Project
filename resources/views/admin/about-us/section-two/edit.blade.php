            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ trans('global.edit') }} About section 2</h4>
                    </div>
                </div>
            </div>

            <div class="row">
                <form method="POST" action="{{ route("admin.about-us.section-2.update", $section2->id) }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $section2->title ?? '') }}" required>
                                            @if($errors->has('title'))
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $section2->description ?? '') }}</textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <a href="{{ $section2->icon_image ?? '#' }}" target="_blank">Click to see previous uploaded image</a>
